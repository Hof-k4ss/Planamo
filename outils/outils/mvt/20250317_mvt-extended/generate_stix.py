...
if __name__ == "__main__":
    ...
    with open("urls.txt") as f:
        urls = list(set([a.strip() for a in f.read().split()]))
    ...
    for u in urls:
        i = Indicator(indicator_types=["malicious-activity"], pattern="[url:value='{}']".format(u), pattern_type="stix")
        res.append(i)
        res.append(Relationship(i, 'indicates', malware))
    ...
    for fp in filepaths:
        i = Indicator(indicator_types=["malicious-activity"], pattern="[file:path='{}']".format(fp), pattern_type="stix")
        res.append(i)
        res.append(Relationship(i, 'indicates', malware))
