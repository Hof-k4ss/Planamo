## Note : Comment ça s'installe ?

[`INSTALL.md`](INSTALL.md)

Est mis à disposition le fichier [`generate_stix.py`](generate_stix.py) afin de générer un fichier stix2 compatible avec ce projet.
