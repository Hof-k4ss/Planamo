...
TCC_ROOT_PATHS = [
    ...
    "private/var/mobile/Library/Logs/CrashReporter/DiagnosticLogs/sysdiagnose/*/logs/Accessibility/TCC.db"
]
    ...
    def check_indicators(self):
        for result in self.results:
            for ioc in self.indicators.get_iocs("processes"):
                if ioc["value"] in result["client"]:
                    self.log.warning("Malicious client \"%s\" had access to %s", result["client"], result["service"])
